...
const ChatSent = ({text, picture, lasttime}) => (
    ...
    <View style={{width: "100%", marginTop: 20, alignItems: "flex-end"}}>
        <View style={{flexDirection:"row"}}>
            ...
            <View style={{width:"20%", justifyContent: "flex-end", paddingLeft:10}}>
                <Thumbnail 
        ...
        <Text style={{fontSize: 11, color: theme.text3, paddingRight: "20%", marginTop: 4}}>
            {lasttime}
        </Text>
